...
export default function ImageOptimiserPage() {
  ...
  return (
    <>
      <SEO
        title="Image Optimizer - Resize, Compress & Convert Images - Tools For Frontend"
        description="Optimize images by resizing, compressing, and converting formats. Free online image optimizer tool for reducing file sizes and improving web performance."
        keywords="image optimizer, image compressor, resize image, compress image, image converter, optimize images, reduce image size"
        ogTitle="Image Optimizer - Tools For Frontend"
