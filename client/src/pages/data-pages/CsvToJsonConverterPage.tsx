...
export default function CsvToJsonConverterPage() {
  ...
  const loading = csvToJson.isPending;
    ...
    <>
      ...
      <div className="flex flex-col gap-10 max-w-8xl">
        <div>
          ...
          <p className="text-muted-foreground">Convert CSV to JSON.</p>
        </div>
        <div className="flex-1 flex flex-col gap-6">
          <div className="flex flex-col gap-3">
            ...
            <Textarea value={csv} id="csv-input" className="h-80 font-mono" onChange={handleCsvChange} placeholder="Paste CSV here or upload a file" />
          </div>
          <div className="flex flex-col gap-3">
