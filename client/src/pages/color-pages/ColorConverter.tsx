...
export default function ColorConverter() {
  ...
  return (
    <>
      <SEO
        title="Color Converter - Tools For Frontend"
        description="Convert colors between different formats including HEX, RGB, HSL, OKLCH, OKLAB, LCH, HWB, and LAB. Free online color converter tool for developers and designers."
        keywords="color converter, hex to rgb, rgb to hsl, color format converter, hex converter, rgb converter, hsl converter, oklch converter"
        ogTitle="Color Converter - Tools For Frontend"
